...
import (
	...
	"github.com/GittyGitGetGud/bsc/accounts/abi"
	"github.com/GittyGitGetGud/bsc/accounts/keystore"
	"github.com/GittyGitGetGud/bsc/cmd/utils"
	...
	"github.com/GittyGitGetGud/bsc/ethclient"
...
func (f *faucet) apiHandler(w http.ResponseWriter, r *http.Request) {
	...
	for {
		...
		default:
			//lint:ignore ST1005 This error is to be displayed in the browser
			err = errors.New("Something funky happened, please open an issue at https://github.com/GittyGitGetGud/bsc/issues")
		}
		if err != nil {
			if err = sendError(wsconn, err); err != nil {
